...
namespace RamosHermanos.Capas.Negocio
{
    class ClienteB
    {
        ...
        public static ClienteEntity BuscarClienteIDINT(int idCliente)
        {
            try
            {
                MySQL.ConnectDB();
        ...
        public static string BuscarNombreClientePJ(int idCliente)
        {
            try
            {
                MySQL.ConnectDB();

                string query = @"SELECT CONCAT(c.idCliente, ' - ',C.nombre)
                                FROM clientes C
                                WHERE idCliente = @idCliente";
